    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 mb-3 p-0">
                <div class="">
                    <div class="card-body">
                        <h2>Start earning <span class="PriceTag">Big</span> from home</h2>
        ...
        <div class="row">
            <div class="col-lg-8 col-md-8 mr-2 p-2 WorkersContainer">
                <h3>Students looking for teachers</h3>
                <p>Join the world offering the language you know the best. You can work for us or you can
                    work independently or do both.
                </p>
