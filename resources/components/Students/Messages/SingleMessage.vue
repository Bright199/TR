<template >
    <div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3 mt-3  me-3 shadow-sm LeftContainer LeftBar">
                ...
                <div class="col-md-8 mt-3  shadow-sm ">
                    <div
                        class="container-jumbotron d-flex justify-content-center border-bottom p-3"
                    >
                        <p>You are messaging 
                            <router-link :to="'/student/single/teacher/'+id">{{teacherDetails.name}}</router-link>
                            </p>
                    </div>
                    <div
