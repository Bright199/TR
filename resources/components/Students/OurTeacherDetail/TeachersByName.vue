    ...
    <div>
        ...
        <div class="container">
            <Pagination
                :data="teachers"
                align="right"
                @pagination-change-page="getTeachersByName"
            />
        </div>
        <!-- {{teachers}} -->
        <!--  -->
...
export default {
    ...
    methods: {
        ...
        getTeachersByName(page = 1) {
            ...
            axios
                .post("/student/getTeachersByName?page=" + page, data)
                .then((response) => {
